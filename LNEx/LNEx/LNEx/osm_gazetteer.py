...
def search_index(bb):
    ...
    # # Send GET request to Photon API to retrieve location data for specified bounding box
    # res = requests.get(f"localhost:9200/photon/api/?q=chennai&bbox={lon1},{lat1},{lon2},{lat2}")
    # data = res.json()
